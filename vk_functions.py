...
class VK:
    ...
    def get_horney_user_info(self, listen_user_id):
        ...
        return h_user_info[0]  ## получаем из списка данных по клиенту, словарик по клиенту
    ...
    def get_country_id(self, country_name):
        ...
        for countries in country_list:
            if countries['title'] == country_name.title():
    ...
    def search_users(self, user_data):
        ...
        for d_user in raw_users_list:
            ...
            d_user_passed_date_id = db.check_db_passed_dates(d_user[0])
            print(d_user_passed_date_id)
            if d_user_db_id is None and d_user_bl_db_id is None and d_user_passed_date_id is None:
